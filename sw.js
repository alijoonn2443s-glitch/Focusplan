...
const APP_SHELL = ['./', './index.html', './styles.css', './mainfest.json', './sw.js', './icon.svg', './js/fp-01.js', './js/fp-02.js', './js/fp-03.js', './js/fp-04.js', './js/fp-05.js', './js/fp-06.js', './js/fp-07.js'];
